...
import com.fifthgen.prahranvet.vetwarebridge.ui.PreloadController;
...
public class Application extends javafx.application.Application {
    ...
    public static volatile PreloadController preloader;
    public static Stage preLoadStage ;
    
    public static void main(String[] args) {
    	
        //FXMLLoader loader2 = new FXMLLoader(ClassLoader.getSystemResource("fxml/Preload.fxml"));

        // Load and display the "splash screen"
        try {
        	preloader = new PreloadController() ;
        	preloader.init();
			preloader.start(preLoadStage);
         } catch (Exception e) {
            Logger.getGlobal().severe("Couldn't initialize Splash Screen.");
            System.exit(0);
        }
